var webAudioPeakMeter = (function (e) {
    ...
    var r = {
        ...
        createContainerDiv: function (e, t) {
            ...
            return (o.style.position = "relative"), (o.style.width = `${n/1.4}px`), (o.style.height = `${r}px`), (o.style.backgroundColor = '#2a2c2d'), e.appendChild(o), o;
        },
        createTicks: function (e, t) {
            ...
            return (
                f.forEach((e, t) => {
                    (e.style.width = `${p}px`), (e.style.bottom = `${i}px`), (e.style.right = `${m * t + p}px`);
                }),
        ...
        createPeakLabels: function (e, t, n) {
            const { borderSize: r, labelColor: a, fontSize: o } = t,
                ...
                h = Array.from(Array(l).keys()).map(() => {
                    const t = document.createElement("div");
                    return e.appendChild(t), (t.style.textAlign = "left"), (t.style.color = a), (t.style.fontSize = `${o}px`), (t.style.position = "absolute"), (t.textContent = "-∞"), (t.style.marginRight = "10%"), t;
                });
            if (i) {
                const e = s / l;
                h.forEach((t, n) => {
                ...
                const e = c / l;
                h.forEach((t, n) => {
                    (t.style.width = 1 * o + "px"), (t.style.right = `${r}px`), (t.style.top = `${e * n + f}px`);
                });
            }
            return h;
        },
    ...
    const c = {
        ...
        tickColor: "#16e1ff",
        labelColor: "#16e1ff",
        gradient: ["red 1%", "#16e1ff 16%", "#16e1ff 45%", "#16e1ff 100%"],
        dbRange: 96,
        dbTickSize: 18,
        maskTransition: "0.1s",
    ...
    var f = {
            ...
            createMeter: function (e, t, n = {}) {
                ...
                (i.tempPeaks = new Array(f).fill(0)),
                    ...
                    (i.peakHoldTimeouts = new Array(f).fill(null)),
                    (i.channelCount = f),
                    ...
                    (t.onaudioprocess = (e) =>
                        (function (e, t, n) {
                            const { inputBuffer: r } = e,
                                { audioMeterStandard: o, peakHoldDuration: l } = t;
                            let i = [];
                            i = "true-peak" === o ? s.calculateTPValues(r, n) : a.calculateMaxValues(r);
                            for (let e = 0; e < i.length; e += 1)
                                (n.tempPeaks[e] = i[e]),
                                    i[e] > n.heldPeaks[e] &&
                                        ((n.heldPeaks[e] = i[e]),
                                        l &&
                                            (n.peakHoldTimeouts[e] && clearTimeout(n.peakHoldTimeouts[e]),
                                            (n.peakHoldTimeouts[e] = setTimeout(() => {
                                                n.heldPeaks[e] = n.tempPeaks[e];
                                            }, l))));
                        })(e, o, i)),
                    l.addEventListener(
                        "click",
